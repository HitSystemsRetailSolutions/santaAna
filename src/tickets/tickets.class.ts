...
class TicketsClass {
  ...
  async insertarTickets(
    arrayTickets: TicketsInterface[],
    ...
    if (this.datosCorrectosParametros(parametros).error == false) {
      ...
      for (let i = 0; i < 1; i++) {
        if (this.datosCorrectosTicket(arrayTickets[0]).error == false) {
          ...
          const infoTime = fechaParaSqlServer(
            new Date(arrayTickets[0].timestamp)
          );
          ...
          for (let j = 0; j < arrayTickets[0].lista.length; j++) {
            ...
            if (typeof arrayTickets[0].lista[j] == "object") {
              ...
              if (
                arrayTickets[0].cliente !== undefined &&
                arrayTickets[0].cliente != "" &&
                arrayTickets[0].cliente !== null
              ) {
              ...
              if (arrayTickets[0].tipoPago === "CONSUMO_PERSONAL") {
                try {
                  idFinalTrabajadorAux = await recHit(
                    parametros.database,
                    `SELECT valor FROM dependentesExtes WHERE id = ${arrayTickets[0].idTrabajador} AND nom = 'CODICFINAL'`
                  );
                  idFinalTrabajador = `[Id:${idFinalTrabajadorAux.recordset[0].valor}]`;
                } catch (err) {
                  console.log(err);
                  arrayTickets[0].comentario =
                    "ERROR EN LA CONSULTA CONSUMO_PERSONAL > idTrabajador a CODIFINAL";
                }
              }
              ...
              /* Tipo es promoción */
              if (
                arrayTickets[0].lista[j].promocion != undefined &&
                arrayTickets[0].lista[j].promocion != null
              ) {
                if (typeof arrayTickets[0].lista[j]._id == "number") {
                  if (
                    typeof arrayTickets[0].lista[j].promocion.esPromo ==
                    "boolean"
                  ) {
                    if (arrayTickets[0].lista[j].promocion.esPromo === false) {
                      ...
                      sql += ` INSERT INTO ${nombreTabla} (Botiga, Data, Dependenta, Num_tick, Estat, Plu, Quantitat, Import, Tipus_venta, FormaMarcar, Otros) VALUES (${
                        ...
                        infoTime.month
                      }-${infoTime.day} ${infoTime.hours}:${infoTime.minutes}:${
                        infoTime.seconds
                      }', 120), ${arrayTickets[0].idTrabajador}, ${
                        arrayTickets[0]._id
                      }, '', ${idArticulo}, ${
                        arrayTickets[0].lista[j].unidades
                      }, ${
                        arrayTickets[0].tipoPago === "CONSUMO_PERSONAL"
                          ? 0
                          : arrayTickets[0].lista[j].subtotal
                      }, '${
                        arrayTickets[0].tipoPago === "CONSUMO_PERSONAL"
                          ? "Desc_100"
                          : "V"
                      ...
                      arrayTickets[0].lista[j].promocion.esPromo == true
                    ) {
                      /* CASO ES PROMO */
                      if (
                        typeof arrayTickets[0].lista[j].promocion.infoPromo ==
                        "object"
                      ) {
                        if (
                          typeof arrayTickets[0].lista[j].promocion.infoPromo
                          ...
                          if (
                            arrayTickets[0].lista[j].promocion.infoPromo
                              .tipoPromo == "COMBO"
                          ) {
                            if (
                              arrayTickets[0].lista[j].promocion.infoPromo
                              ...
                              arrayTickets[0].lista[j].promocion.infoPromo
                                .idSecundario != 0 &&
                              typeof arrayTickets[0].lista[j].promocion
                                .infoPromo.idPrincipal == "number" &&
                              typeof arrayTickets[0].lista[j].promocion
                                .infoPromo.idSecundario == "number"
                            ) {
                              let importePrincipal =
                                arrayTickets[0].lista[j].promocion.infoPromo
                                  .cantidadPrincipal *
                                arrayTickets[0].lista[j].promocion.infoPromo
                                  .unidadesOferta *
                              ...
                              if (
                                importePrincipal == null ||
                                importeSecundario == null
                              ) {
                                importePrincipal = 0;
                                importeSecundario = 0;
                              }
                              if (arrayTickets[0].total >= 0) {
                                sql += ` INSERT INTO ${nombreTabla} (Botiga, Data, Dependenta, Num_tick, Estat, Plu, Quantitat, Import, Tipus_venta, FormaMarcar, Otros) VALUES (${
                                  ...
                                  infoTime.month
                                }-${infoTime.day} ${infoTime.hours}:${
                                  infoTime.minutes
                                }:${infoTime.seconds}', 120), ${
                                  arrayTickets[0].idTrabajador
                                }, ${arrayTickets[0]._id}, '', ${
                                  arrayTickets[0].lista[j].promocion.infoPromo
                                    .idPrincipal
                                }, ${
                              ...
                              arrayTickets[0].comentario =
                                "ERROR, idPrincipal o idSecundario NO ES NUMBER o bien ALGUNO DE LOS DOS IDS ES 0";
                            }
                          } else if (
                            arrayTickets[0].lista[j].promocion.infoPromo
                            ...
                            if (
                              arrayTickets[0].lista[j].promocion.infoPromo
                                .precioRealPrincipal == null
                            ) {
                              arrayTickets[0].lista[
                                j
                              ].promocion.infoPromo.precioRealPrincipal = 0;
                            }
                            ...
                            if (
                              ...
                              if (arrayTickets[0].total >= 0) {
                                sql += ` INSERT  INTO ${nombreTabla} (Botiga, Data, Dependenta, Num_tick, Estat, Plu, Quantitat, Import, Tipus_venta, FormaMarcar, Otros) VALUES (${
                                  ...
                                  "CONSUMO_PERSONAL"
                                    ? 0
                                    : arrayTickets[0].lista[j].promocion
                                        .infoPromo.precioRealPrincipal
                                }, '${
                                  arrayTickets[0].tipoPago ===
                                  "CONSUMO_PERSONAL"
                                    ? "Desc_100"
                              ...
                              arrayTickets[0].comentario =
                                "ERROR, idPrincipal NO ES NUMBER o ES 0";
                            }
                          } else {
                            arrayTickets[0].comentario =
                              "ERROR, infoPromo.tipoPromo NO ES 'COMBO' NI 'INDIVIDUAL'";
                          }
                        } else {
                          arrayTickets[0].comentario =
                            "ERROR, infoPromo.tipoPromo NO ES STRING";
                        }
                      } else {
                        arrayTickets[0].comentario =
                          "ERROR, promocion.infoPromos NO ES OBJECT";
                      }
                    }
                  } else {
                    arrayTickets[0].comentario =
                      "ERROR, EL OBJETO promocion.esPromo NO ES UN BOOLEAN";
                  }
                } else {
                  arrayTickets[0].comentario =
                    "ERROR, EL _ID DE LA LISTA NO ES UN NUMBER";
                }
              } else {
                arrayTickets[0].comentario =
                  "ERROR, EL OBJETO PROMOCIÓN ES NULL O UNDEFINED";
              }
            } else {
              arrayTickets[0].comentario =
                "ERROR, LA POSICIÓN DE LA LISTA NO ES UN OBJETO";
            }
          } // Final for j
          ...
          try {
            logger.Info(
              `tienda: ${parametros.codigoTienda} idTicket: ${arrayTickets[0]._id} sql: ${sql}`
            );
            ...
            if (res.recordset.length > 0) {
              if (res.recordset[0].resultado == "YA_EXISTE") {
                ...
                let sql2 = `IF EXISTS (SELECT * FROM tocGameInfo WHERE licencia = ${
                  parametros.licencia
                }) 
                                                BEGIN
                  ...
                  parametros.database
                }', ${arrayTickets[0]._id}, ${parametros.codigoTienda}, '${
                  parametros.nombreTienda
                }', NEWID(), '2.0.0', ${Date.now()})
                                                END`;
                ...
                server.emit("resSincroTickets", {
                  error: true,
                  mensaje:
                    "SanPedro: Error, caso incontrolado. Respuesta desconocida.",
                  arrayTickets,
                  idTicketProblematico: arrayTickets[0]._id,
                });
                break;
              }
            } else {
          ...
          // Error general de datos del ticket
          error = true;
      ...
      if (error) {
        // Solo para las primeras comprobaciones
      ...
      server.emit("resSincroTickets", {
        error: true,
        arrayTickets,
        mensaje: "SanPedro: Error, parámetros incorrectos",
      });
    }
  }
    ...
    try {
      ...
      if (!checkParametros && !checkTicket) {
        ...
        for (let j = 0; j < ticket.lista.length; j++) {
          ...
          if (ticket.lista[j].promocion.esPromo === false) {
            // Modo normal
            ...
            sql += ` INSERT INTO ${nombreTabla} (Botiga, Data, Dependenta, Num_tick, Estat, Plu, Quantitat, Import, Tipus_venta, FormaMarcar, Otros) VALUES (${
              ...
              infoTime.day
            } ${infoTime.hours}:${infoTime.minutes}:${
              infoTime.seconds
            }', 120), ${ticket.idTrabajador}, ${
              ticket._id
            }, '', ${idArticulo}, ${ticket.lista[j].unidades}, ${
              ticket.tipoPago === "CONSUMO_PERSONAL"
                ? 0
                : ticket.lista[j].subtotal
            }, '${
              ticket.tipoPago === "CONSUMO_PERSONAL" ? "Desc_100" : "V"
            }', 0, '${
              ticket.tipoPago === "CONSUMO_PERSONAL"
                ? idFinalTrabajador
                : campoOtros
            ...
            if (ticket.lista[j].promocion.infoPromo.tipoPromo == "COMBO") {
              // Modo combo
              if (
                ticket.lista[j].promocion.infoPromo.idPrincipal != 0 &&
                ticket.lista[j].promocion.infoPromo.idSecundario != 0
              ) {
                let importePrincipal =
                  ticket.lista[j].promocion.infoPromo.cantidadPrincipal *
                  ticket.lista[j].promocion.infoPromo.unidadesOferta *
                  ticket.lista[j].promocion.infoPromo.precioRealPrincipal;
                let importeSecundario =
                  ticket.lista[j].promocion.infoPromo.cantidadSecundario *
                  ticket.lista[j].promocion.infoPromo.unidadesOferta *
                  ticket.lista[j].promocion.infoPromo.precioRealSecundario;

                if (
                  typeof importePrincipal != "number" ||
                  typeof importeSecundario != "number"
                ) {
                  throw Error(
                    "Importe principal o secundario con valores incorrectos"
                  );
                }
                ...
                if (ticket.total >= 0) {
                  sql += ` INSERT INTO ${nombreTabla} (Botiga, Data, Dependenta, Num_tick, Estat, Plu, Quantitat, Import, Tipus_venta, FormaMarcar, Otros) VALUES (${
                    ...
                    infoTime.seconds
                  }', 120), ${ticket.idTrabajador}, ${ticket._id}, '', ${
                    ticket.lista[j].promocion.infoPromo.idPrincipal
                  }, ${
                    ticket.lista[j].promocion.infoPromo.cantidadPrincipal *
                    ticket.lista[j].promocion.infoPromo.unidadesOferta
                  }, ${
                  ...
                  sql += ` INSERT INTO ${nombreTabla} (Botiga, Data, Dependenta, Num_tick, Estat, Plu, Quantitat, Import, Tipus_venta, FormaMarcar, Otros) VALUES (${
                    ...
                    ticket.lista[j].promocion.infoPromo.idSecundario
                  }, ${
                    ticket.lista[j].promocion.infoPromo.cantidadSecundario *
                    ticket.lista[j].promocion.infoPromo.unidadesOferta
                  }, ${
                ...
                ticket.comentario =
                  "ERROR: idPrincipal o idSecundario incorrecto";
                throw Error("ERROR: idPrincipal o idSecundario incorrecto");
              }
            } else if (
              ticket.lista[j].promocion.infoPromo.tipoPromo == "INDIVIDUAL"
            ) {
              // Tipo individual
              if (
                typeof ticket.lista[j].promocion.infoPromo
                  .precioRealPrincipal != "number"
              ) {
                ticket.comentario =
                  "ERROR: El precioRealPrincipal de la promoción individual es incorrecto";
                throw Error(
                  "ERROR: El precioRealPrincipal de la promoción individual es incorrecto"
                );
              }
              ...
              if (
                typeof ticket.lista[j].promocion.infoPromo.idPrincipal ==
                  "number" &&
                ticket.lista[j].promocion.infoPromo.idPrincipal != 0
              ) {
                if (ticket.total >= 0) {
        ...
        sql = `
                ...
                `;
        logger.Info(
          `tienda: ${parametros.codigoTienda} idTicket: ${ticket._id} sql: ${sql}`
        ); // TRAZA TEMPORAL
        ticket.intentos += 1;
        const res = await recHit(parametros.database, sql);
        if (res.recordset.length > 0) {
          if (res.recordset[0].resultado == "YA_EXISTE") {
            ...
            throw Error(
              "Error, caso incontrolado. Respuesta desconocida: ticket: " +
                ticket
            );
          }
        } else {
